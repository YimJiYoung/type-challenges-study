...
type Length<Value> = Value extends { length: infer L } ? L : never;

type NumberMax<H, Arr extends unknown[] = []> = Length<Arr> extends H
  ? never
  : Length<Arr> | NumberMax<H, [...Arr, unknown]>;

type NumberRange<L, H> = Exclude<NumberMax<H>, NumberMax<L>> | H;
